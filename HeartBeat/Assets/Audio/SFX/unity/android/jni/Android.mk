...
# audiolib.so
include $(CLEAR_VARS)
LOCAL_MODULE := untitled_adf9e3cef0d1_lib
LOCAL_MODULE_FILENAME := libHv_untitled_adf9e3cef0d1_AudioLib
LOCAL_CFLAGS := -std=c11 -DNDEBUG -DHV_SIMD_NEON -O3 -ffast-math -fPIC
LOCAL_CPPFLAGS := -std=c++11
...
# libplugin.so
include $(CLEAR_VARS)
LOCAL_MODULE := untitled_adf9e3cef0d1_plugin
LOCAL_MODULE_FILENAME := AudioPlugin_Hv_untitled_adf9e3cef0d1
LOCAL_CFLAGS := -std=c11 -DNDEBUG -DHV_SIMD_NEON -O3 -ffast-math -fPIC
LOCAL_CPPFLAGS := -std=c++11
